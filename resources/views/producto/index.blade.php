                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row mb-3">
                                            <label><span class="fw-bolder">Fecha de vencimiento: </span>{{ $item->fecha_vencimiento == '' ? 'No tiene' : $item->fecha_vencimiento }}
                                            </label>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div>
                                                @if ($item->img_path != null)
                                                    <img src="{{ asset('storage/public/productos/'.$item->img_path) }}"
                                                        alt="{{ $item->nombre }}"
                                                        loading="lazy"
